...
public class YluoMarqueeView extends View {
	...
	private static final String TAG = "YluoMarqueeView";
	...
	private void init() {
		...
		mContents.add(makeMarqueeLine("大促","点击领取爱宠<<我是QQ>>"));
	
		mContents.add(makeMarqueeLine("热","夏有乔木,雅望天堂"));
		
		mContents.add(makeMarqueeLine("燃","我是跑马灯---哈哈"));
